...
class MLAdaptiveSuperTrend:
    def __init__(self, atr_len=5, fact=2, training_data_period=50,
                 highvol=0.7, midvol=0.4, lowvol=0.2):
    ...
    def calculate_signals(self, df):
        ...
        for i in range(len(df)):
            ...
            if len(vol_data) < self.training_data_period:
                # Use default clustering for insufficient data
                assigned_centroid, cluster, hv, mv, lv = self._default_clustering_result(vol_data.iloc[-1])
            else:
        ...
        return supertrend_values, directions, clusters, centroids
...
def run_ml_supertrend_backtest(df):
    ...
    # Calculate signals
    supertrend_values, directions, clusters, centroids = ml_st.calculate_signals(df)
...
if __name__ == "__main__":
    ...
    # print("Sample data created. Replace this with your actual OHLC data.")
