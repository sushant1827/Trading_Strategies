...
spot_path = 'D:/Sushant/Fyers_AlgoTrade/Fyers_Data/Nifty50_Index'

# spot_file = 'NIFTYBANK_INDEX_60_Min.csv'
# spot_path = 'D:/Sushant/Fyers_AlgoTrade/Fyers_Data/BankNifty_Index'
...
# options_path = 'D:/Sushant/Fyers_AlgoTrade/Fyers_Data/New_Options_Data_BnF/2024'
options_path = 'D:/Sushant/Fyers_AlgoTrade/Fyers_Data/New_Options_Data_Nfty/2024'
...
for current_day in pd.date_range(start=start_date, end=end_date):
    ...
    current_day = current_day + time_delta

    spot_day = spot_df[(spot_df['Date'] == current_day)]

    if spot_day.empty:
        continue

    spot_price = spot_day.iloc[0]['Open']
    spot_strike = round(spot_price / 100) * 100

    # CE_strike = spot_strike + 300
    # PE_strike = spot_strike - 300
...
df.to_csv('NFT_trading_data.csv', index=False)
...
# Total profit                : 80932.49
# Total brokerage             : 18329.72
# Net profit (after brokerage): 62602.77
# Net profit in percent       : 20.87%
# Max profit                  : 8126.73
# Max loss                    : -3734.55
# Profit count                : 91
# Loss count                  : 75
# Profit to loss ratio        : 1.21
# Max drawdown                : 9028.88
# Consecutive wins            : 6
# Consecutive losses          : 5
# Win percentage              : 54.82%
# Loss percentage             : 45.18%
